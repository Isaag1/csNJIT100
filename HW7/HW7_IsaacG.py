...
def litCricFriend(wordList, text):
    ...
    textList= []
    for i in text:
        textList += i.strip(string.punctuation)
...
'''
The results show that Poe and neruda both used 'a' and 'an' differently.
I had the word 'the' appear no times even though
I can see the word 'the'. I probably had an error.
'''
